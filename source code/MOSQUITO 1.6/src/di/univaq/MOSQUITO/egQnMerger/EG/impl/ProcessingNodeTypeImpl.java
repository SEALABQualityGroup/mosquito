...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Processing Node Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link di.univaq.MOSQUITO.egQnMerger.Devices.impl.ProcessingNodeTypeImpl#getNodeName <em>Node Name</em>}</li>
 *   <li>{@link di.univaq.MOSQUITO.egQnMerger.Devices.impl.ProcessingNodeTypeImpl#getProbability <em>Probability</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProcessingNodeTypeImpl extends EObjectImpl implements ProcessingNodeType {
	/**
	 ...
	 * @generated
	 */
	protected ProcessingNodeTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DevicesPackage.Literals.PROCESSING_NODE_TYPE;
	}
	...
	public void setNodeName(String newNodeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DevicesPackage.PROCESSING_NODE_TYPE__NODE_NAME, oldNodeName, nodeName));
	}
	...
	public void setProbability(float newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DevicesPackage.PROCESSING_NODE_TYPE__PROBABILITY, oldProbability, probability, !oldProbabilityESet));
	}
	...
	public void unsetProbability() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DevicesPackage.PROCESSING_NODE_TYPE__PROBABILITY, oldProbability, PROBABILITY_EDEFAULT, oldProbabilityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DevicesPackage.PROCESSING_NODE_TYPE__NODE_NAME:
				return getNodeName();
			case DevicesPackage.PROCESSING_NODE_TYPE__PROBABILITY:
